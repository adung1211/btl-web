...
--
-- Host: localhost:3306
-- Generation Time: May 05, 2024 at 03:26 PM
...
CREATE TABLE `products` (
  ...
  `warrant` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'RTX 4060', 'VGA', 'https://hanoicomputercdn.com/media/product/72807_card_man_hinh_asus_dual_rtx_4060_ti_o8g_gaming__1_.jpg', 9000000, 'MSI', '36', 'Card màn hình này được trang bị chip đồ họa NVIDIA GeForce RTX 4060, hứa hẹn mang lại hiệu năng mạnh mẽ cho các tác vụ chơi game và sáng tạo nội dung. ', 0),
